      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="#">Ajout Client</a>
            <a class="collapse-item" href="clients">Liste des Client</a>
...
<div class="nav navbar-default">
    ...
    <div class="container">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h1>Formulaire des clients</h1></div>
            <div class="panel-body">
                <form action="clientController" method="POST">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="numt">Telephone</label>
                        <input class="form-control" type="text" name="numt" id="numt"/>
                    </div>
                    <div class="form-group">
